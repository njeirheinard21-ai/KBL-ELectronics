...
export function Settings() {
  return (
    <div className="space-y-8">
      <Helmet>
        <title>Store Configuration - Admin KBL Electronics</title>
      </Helmet>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-fg-muted text-sm mt-1">Global store preferences, tax rates, payment gateways, and API keys</p>
        </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-12 text-center min-h-[350px] flex flex-col items-center justify-center">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Store Configuration</h2>
        <p className="text-fg-muted max-w-md mx-auto">
          Global system configuration preferences and third-party integration settings are currently being integrated.
        </p>
      </div>
    </div>
  );
