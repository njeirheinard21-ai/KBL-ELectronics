...
export function Staff() {
  return (
    <div className="space-y-8">
      <Helmet>
        <title>Staff Management - Admin KBL Electronics</title>
      </Helmet>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-fg-muted text-sm mt-1">Manage team accounts, role-based access control, and audit permissions</p>
        </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-12 text-center min-h-[350px] flex flex-col items-center justify-center">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Staff & RBAC Module</h2>
        <p className="text-fg-muted max-w-md mx-auto">
          Staff administration and granular role assignments will be enabled in the upcoming v2 enterprise release.
        </p>
      </div>
    </div>
  );
